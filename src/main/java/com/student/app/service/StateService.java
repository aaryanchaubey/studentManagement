...
public class StateService {
	...
	public List<Object> getStates(String country) throws RestClientException, URISyntaxException{
		...
		ResponseEntity<Object[]> data =  restTemplate.exchange("https://www.universal-tutorial.com/api/states/"+country, HttpMethod.GET, entity, Object[].class);
		
		log.info("get response - "+data.getBody().toString());
		List<Object> listofStates = new ArrayList<>(Arrays.asList(data.getBody()));
//		
		return listofStates;
	}
